...
const Header = () => {
  return (
    <div className='py-5 px-5 md:px-12 lg:px-29'>
        ...
        <div className='text-center my-8'>
           <h1 className='text-3xl sm:text-5xl font-medium'>Latent Blogs</h1>
           <p className='mt-10 max-w-[740px] m-auto text-xs sm:text-base'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. A, quos maiores! Placeat sapiente impedit cumque animi accusantium quasi quaerat ab!</p>
